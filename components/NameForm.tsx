...
export default function NameForm({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* panel */}
      <div className="relative z-10 -translate-y-13 h-auto rounded-xl w-80 border-2 border-black dark:border-white/30 bg-white dark:bg-slate-950 p-3 shadow-2xl">
